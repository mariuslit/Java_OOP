package k_2_08_uzduotisSavaitgaliui_masinos;
...
public class MainCars {
    ...
    public static void main(String[] args) {
        ...
        try {
            String path = new File("").getAbsolutePath() + "\\src\\k_2_08_uzduotisSavaitgaliui_masinos\\";

            Car[] cars = skaityti(path + "dataRead.txt");
